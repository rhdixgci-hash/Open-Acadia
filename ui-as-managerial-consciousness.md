...
## Keywords
UI design, managerial ideology, algorithmic management, sociotechnical systems, critical UX, organizational power, software anthropology, digital labor studies
...
UI is not just a medium—it is **executive cognition made operational**.

---

## 2. From Managerial Mind to Interface Logic
Classic management theory assumed:
- supervisors observe
- managers decide
- workers execute

In software-mediated organizations:
- interfaces observe
- interfaces decide
- workers comply

This shift marks the rise of **managerial consciousness without managers**.

---

## 3. UI Components as Power Instruments

### 3.1 Tables: The Illusion of Objectivity
Tables present:
- rows as entities
- columns as comparable attributes
- cells as neutral facts

**Hidden effect**
- Complex labor becomes flattened
- Context disappears
- Deviations become “errors”

Tables do not just display work — they **discipline perception**.

---

### 3.2 Dropdowns: Controlled Freedom
Dropdowns appear to offer choice.

In reality:
- options are pre-approved
- alternatives are excluded
- non-standard actions become impossible

This is **bounded autonomy**, not empowerment.

---

### 3.3 Dashboards: Attention as Governance
...
- make resistance illegible

This is management **by design**, not command.

---

## 5. Labor Without Voice
